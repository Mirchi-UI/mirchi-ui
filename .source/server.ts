...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "components/meta.json": __fd_glob_1, }, {"index.mdx": __fd_glob_2, "welcome.mdx": __fd_glob_3, "components/background-circles.mdx": __fd_glob_4, "components/buttons.mdx": __fd_glob_5, });