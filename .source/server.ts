...
export const docs = await create.docs("docs", "content/docs", {"2.json": __fd_glob_0, }, {"index.mdx": __fd_glob_1, "welcome.mdx": __fd_glob_2, "blocks/faqs.mdx": __fd_glob_3, "components/background-circles.mdx": __fd_glob_4, "components/buttons.mdx": __fd_glob_5, });