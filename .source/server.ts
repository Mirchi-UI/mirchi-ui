// @ts-nocheck
import * as __fd_glob_11 from "../content/docs/components/three-d-card.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/components/text.mdx?collection=docs"
