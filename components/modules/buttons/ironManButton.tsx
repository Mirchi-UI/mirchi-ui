...
interface IronManButtonProps {
  text?: string;
}

const IronManButton: React.FC<IronManButtonProps> = ({ text = "Hover Me" }) => {
  useEffect(() => {
  ...
  return (
    <button className="iron-btn">
      <svg className="layer" viewBox="0 0 734.93 1135.91">
        <defs></defs>
        <path
          className="cls-1"
